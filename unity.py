# -*- coding: utf-8 -*-
"""
Created on Thu Sep 26 07:52:59 2019

@author: Nipun's Castel
"""
...
while capture.isOpened():
    ...
    try:
        ...
        # Check if previously hand was wide open (3/4 fingers in previous frames), and 4 and is now a fist (0 fingers)
        if(count_defects > 3  in last):
            last = []
